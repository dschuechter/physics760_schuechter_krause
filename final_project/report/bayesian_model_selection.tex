...
We chose a rather simple model that can easily be scaled up for higher order polynomials. The benefit of the shown simpler model is, that the reader can easily follow the train of thought.  
