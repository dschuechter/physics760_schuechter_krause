...
\title{All about that Bayes\\Exploring \textsc{Monte-Carlo}-integration techniques in Bayesian model selection}% Force line breaks with \\
...
We mainly write everything that is in \cite{sivia,test}.
