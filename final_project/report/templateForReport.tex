...
\begin{abstract}
\noindent This paper is an introduction to the concepts of \textsc{Bayesian} model selection. \textsc{Bayesian} statistics provide quantitative measures for model comparison, namely \textsc{Bayes} factor and \textsc{Bayes} complexity. 
\end{abstract}
\maketitle
